...
|-------|------|-------|---------|-----------------|
| **Qwen 2.5 1.5B** | ~1.5 GB | Fast | Good | Quick enhancement, limited RAM |
| **Qwen 3 1.5B** | ~1.5 GB | Fast | Good | Latest Qwen, balanced |
| **Gemma 3 2B** | ~2 GB | Medium | Better | Higher quality, more RAM |
| **Phi-3 3.8B** | ~3.8 GB | Slower | Best | Maximum quality, plenty of RAM |

<Note>
  **Recommended for beginners:** **Qwen 3 1.5B** - Good balance of speed, quality, and resource usage.
</Note>

### Model Selection Guide

<AccordionGroup>
  <Accordion title="Qwen 2.5/3 1.5B - Fast and lightweight" icon="gauge-high">
    **Best for:**
  ...
  <Accordion title="Gemma 3 2B - Better quality" icon="medal">
    **Best for:**
    ...
    **Quality:** Excellent grammar, better formatting and tone
  </Accordion>

  <Accordion title="Phi-3 3.8B - Maximum quality" icon="crown">
    **Best for:**
    ...
    **Processing time:** ~5-7 seconds per paragraph
...
<Steps>
  ...
  <Step title="Choose a model">
    ...
    - **Qwen 3 1.5B** (recommended for beginners)
    - **Gemma 3 2B** (better quality)
    - **Phi-3 3.8B** (maximum quality)
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="No usage costs" icon="dollar-sign">
    Unlimited enhancement with no per-use charges.
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Enhancement is very slow (> 10 seconds)" icon="hourglass">
    - Try a smaller model (Qwen 1.5B instead of Phi-3)
  ...
  <Accordion title="Enhancement quality is poor" icon="spell-check">
    - Try a larger model (Gemma or Phi-3)
...
|-------|--------------|-------|---------|---------------|
| **Qwen 3 1.5B** | 8GB+ | Fast | Good | Everyday use, 8GB Macs |
| **Gemma 3 2B** | 12GB+ | Medium | Better | Professional writing, 16GB Macs |
| **Phi-3 3.8B** | 16GB+ | Slower | Best | Critical writing, maximum quality |
