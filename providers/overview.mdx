...
<AccordionGroup>
  ...
  <Accordion title="Best free option" icon="gift">
    **Parakeet** — Included with Stenox, runs locally, and has no provider quota or per-minute charge.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Best local default" icon="sparkles">
    **Gemma on MLX** — Included, private, and optimized for Apple Silicon.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Best Quality" icon="crown">
    **DeepGram + Gemini** — High-quality cloud transcription and enhancement using your own API keys.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Free Access" icon="gift" href="/pricing/overview">
    No license, subscription, or built-in usage limit.
  </Card>
</CardGroup>
