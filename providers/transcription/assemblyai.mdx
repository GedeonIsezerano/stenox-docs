...
|---------|------------|----------|------------|
| **Free credits** | $50 | $200 | Unlimited (local) |
| **Speed** | Fast (1-2s) | Fastest (< 1s) | Medium (3-5s) |
| **Accent handling** | Excellent | Very Good | Good |
| **Multilingual** | 6 languages | 30+ languages | 90+ languages |
| **Privacy** | Cloud | Cloud | 100% local |
| **Post-free pricing** | $0.0009/min | $0.0125/min | Free |

<Tip>
  **Best combo:** Use AssemblyAI for free credits, then switch to WhisperKit (free) when credits run out, or pay for AssemblyAI if you love the accuracy.
</Tip>
