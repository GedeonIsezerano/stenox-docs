...
<Tip>
  ...
  **Perfect for:** Regular users who don't need unlimited transcription. The free tier is sufficient for most personal and professional use.
...
|---------|--------------|----------|------------|
| **Free tier** | Rate-limited free tier | $200 credits | Unlimited (local) |
...
<Tip>
  **Strategy:** Start with Groq free tier, use DeepGram's $200 credits when you hit rate limits, then switch to WhisperKit (free forever) for unlimited use.
</Tip>
