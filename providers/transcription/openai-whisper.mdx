...
<CardGroup cols={2}>
  <Card title="Add AI Enhancement" icon="sparkles" href="/providers/llm/google-gemini">
    Use Gemini with your own API key for cloud text enhancement.
  </Card>

  <Card title="Create Profiles" icon="sliders" href="/profiles/creating-profiles">
    Use OpenAI Whisper transcription for specific contexts.
  </Card>
</CardGroup>
