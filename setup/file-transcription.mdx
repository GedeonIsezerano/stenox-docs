...
Stenox 1.0 does not impose a file transcription or recording time limit. Local processing time depends on file length and your Mac. If you select a BYOK provider, that provider's account quota and charges apply.

<Note>
  Local Parakeet transcription has no provider quota and keeps the audio on your Mac.
</Note>
