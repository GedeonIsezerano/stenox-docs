...
<AccordionGroup>
  ...
  <Accordion title="Check account status" icon="user">
    ...
    - For BYOK providers, ensure you have not exceeded that provider's quota
...
<AccordionGroup>
  ...
  <Accordion title="DeepGram/AssemblyAI credits exhausted" icon="credit-card">
    ...
    **Options:**
    ...
    [Review cloud provider options →](/providers/cloud-byok)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Check macOS version" icon="apple">
    - Stenox 1.1 requires macOS 15.0 (Sequoia) or later
...
- ✅ **macOS 15.0+** (check About This Mac)
